...
public class SetService {
	...
	/**
	 * Hash 단어가 포함된 컬렉션은 
	 * 무조건 equals(), hashCode()가 오버라이딩 되어있어야한다! 
	 * 
	 * @@@ Object가 제공하는 메서드 오버라이딩 목적 @@@ 
	 * 
	 * - equals() : 객체의 필드가 같은지 비교(동등비교) 
	 * 
	 * - hashCode() : 객체의 식별번호
...
//		Set<Person> personSet = new HashSet<Person>();
	...
	public void test3() {
		...
		/* 향상된 for 문
		 * - 배열, 컬렉션의(List,Set) 요소를 하나씩 순차 접근
