...
public class StudentService {
	...
	/** targetName과 이름이 일치하는 학생 객체 변환 service 메서드
	 * 
	 * @param togetName
	 * @return
	 * */
...
// 1) students 배열에서 입력 받은 index번째 요소를 null로 바꿈
			students[index] = null;
