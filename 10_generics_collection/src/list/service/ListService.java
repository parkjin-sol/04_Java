 ...
 */
	...
	public void test2() {
		...
		/* void add(int index, E e) : index 번째 e 추가 (중간 삽입) */
		menuList.add(1, "갈비탕");
...
//		}
		...
		for(int i=0 ; i<100_000 ; i++) { // 100만 바퀴
			// 1번 인덱스에 난수 삽입(중간 삽입)
