...
public class WrapperService {
	...
	public void test3() {
		...
		System.out.println("Int는 비트? " + Integer.SIZE );
		...
		System.out.println("double는 비트? " + Double.SIZE );
		System.out.println("double 최대 값 : " + Double.MAX_VALUE);
		System.out.println("double 최대 값 : " + Double.MIN_VALUE);
