...
public class StringService {
		 ...
		 * 	  ex) String s1 = "Hello";
		 * 	 	-> heap 메모리 영역에 존재하는 
		 * 			 String Comstant(상수)Pool에 String 객체 생성 
		 * 
		 * 2) new 연산자를 이용하여 생성
		 ...
		 * 
		 * - String 리터럴("")를 이용해
		 * 	 생성된 Stirng 객체가 저장되는 Heap 내부 영역
		 * 
		 * - String 리터럴을 이용해서
		...
		public void test2() {
			 ...
			 *  - StringBuffder : Thread Safe 지원(동기 느림)
			 */
			...
			/* toString() : StringBuilder 객체에 저장된 값을 Stromg gid
			 * 
			 */
			System.out.println();
			System.out.println();
			...
			/* delete(int start, int end ) : start
			 *  
			 */
		}
}
