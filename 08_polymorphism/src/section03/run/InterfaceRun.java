...
import section03.dto.PJSCalculator;
import section03.dto.PJSCalculator2;
...
//		Calculator calc = new PJSCalculator();
...
//		Calculator calc = new PJSCalculator2();
		Calculator calc = new BDHCalculator();
		
		System.out.println( calc.plus(12, 30));
		System.out.println( calc.minus(100, 99));
		System.out.println( calc.multi(3333, 4444));
		System.out.println( calc.div(33, 11));
		System.out.println( calc.mod(50, 11));
		System.out.println( calc.pow(2, 16));
		System.out.println( calc.areaOfCircle(30));
	}
}
