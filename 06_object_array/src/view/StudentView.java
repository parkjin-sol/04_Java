...
//			System.out.println(result); 
	 ...
	 *  <pre>
	 *  - 인덱스를 입력 받아
	 *  	StudentService.selectIndex()fh wjsekf
	 *  
	...
	private void selectIndex() {
		...
		// StudntService.selectIndex()로 index 전달
		// -> 학생 
	 ...
	 * 		1) index 범위 초과 : "인덱스의 범위가 올바르지 않습니다"
	 * 		2) 참조하는 학생이 없을 경우 : 
...
//	    char confirm = sc.next().toUpperCase().charAt(0); char 형태로 반환
//      if (confirm == 'N') {
