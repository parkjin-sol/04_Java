...
public class Main1 {
	public static void main(String[] args) {
		...
		System.out.println("calc1.sumTwoNumber(3, 5) : " + calc1.sunTwoNumber(3, 5)); // 8
		
		/* 2. 익명 내부 클래스  이용 */
		Calculator calc2 = new Calculator() {
			
			@Override
			public int sunTwoNumber(int a, int b) {
				return a + b;
			}
		};
		System.out.println("calc.sumTwoNumber(10,55) : " + calc2.sunTwoNumber(10, 55));
		...
		+ calc3.sunTwoNumber(100, 899)); // 100
		
		// "{} 내부 코드가 한줄 -> {}, return 생략 가능
		Calculator calc4 = (a, b) -> 2 * (a + b);
		
		System.out.println("calc4.sunTwoNumber(3, 4)" 
		+ calc4.sunTwoNumber(3, 4));
		
		// a^2 + b^3 반환하는 람다식 작성 
		Calculator calc5 = (a, b) -> a * a + b * b * b ; 
		
		System.out.println("calc5.sunTwoNumber(3, 2)" 
		+ calc5.sunTwoNumber(3, 2)); // 17
	}
}
